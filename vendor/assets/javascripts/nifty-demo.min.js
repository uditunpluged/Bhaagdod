...
$(document).ready(function () {
    ...
    var n = "easeInQuart easeOutQuart easeInBack easeOutBack easeInOutBack steps jumping rubber", i = $("#demo-anim"), a = $("#demo-ease");
    ...
    var s = $("#demo-nav-coll"), o = $("#demo-nav-fixed"), f = $("#demo-nav-offcanvas");
    ...
    var c = $("#demo-asd-vis"), d = $("#demo-asd-fixed"), l = $("#demo-asd-align"), r = $("#demo-asd-themes");
    ...
    var m = $(".demo-theme"), h = function (e, t) {
        var n = $("#theme"), i = "css/themes/type-" + t + "/" + e + ".min.css";
    ...
    if ($("#demo-alert").on("click", function (e) {
        ...
        var p = ["settings-animation", "settings-nav-fixed", "settings-nav-collapsed", "settings-nav-offcanvas", "settings-asd-visibility", "settings-asd-fixed", "settings-asd-align", "settings-asd-theme", "settings-navbar-fixed", "settings-footer-fixed", "settings-theme-type", "settings-theme-name"], u = function (e, t) {
            0 == t ? $.removeCookie(e, {path: "/"}) : $.cookie(e, t === !0 ? "1" : t, {expires: 7, path: "/"})
        }, C = function () {
            for (var e = 0; e < p.length; e++)$.removeCookie(p[e], {path: "/"})
        };
